...
TodoApp is a simple todoApp that will help somebody to know the basics of React Native. 
On this project i have done the basics and bests pratices to build a react native app.
After you get a repository from git, run npm install to install dependencies.
...
If you launch an amulator, you can click on Run on iOS or Android Emulator to run your app on emulator.
